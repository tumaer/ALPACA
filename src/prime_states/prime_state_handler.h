...
class PrimeStateHandler {
   ...
   inline void DoConvertPrimeStatesToConservatives( MaterialName const& material, PrimeStatesContainerType const& prime_states_container, ConservativesContainerType& conservatives_container ) const {
      ...
      PrimeStatesToConservatives( material_manager_.GetMaterial( material ).GetEquationOfState(), prime_states_container, conservatives_container );
   }
   ...
   inline void DoConvertConservativesToPrimeStates( MaterialName const& material, ConservativesContainerType const& conservatives_container, PrimeStatesContainerType& prime_states_container ) const {
      ...
      ConservativesToPrimeStates( material_manager_.GetMaterial( material ).GetEquationOfState(), conservatives_container, prime_states_container );
   }
...
template<typename PrimeStatesContainerType, typename ConservativesContainerType>
inline void PrimeStatesToConservatives( EquationOfState const& eos, PrimeStatesContainerType const& prime_states_container, ConservativesContainerType& conservatives_container ) {
...
template<typename ConservativesContainerType, typename PrimeStatesContainerType>
inline void ConservativesToPrimeStates( EquationOfState const& eos, ConservativesContainerType const& conservatives_container, PrimeStatesContainerType& prime_states_container ) {

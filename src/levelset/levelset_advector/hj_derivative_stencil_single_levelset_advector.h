...
/**
 * @brief The HjDerivativeStencilSingleLevelsetAdvector propagates a single-level set field in time.
 */
class HjDerivativeStencilSingleLevelsetAdvector : public LevelsetAdvector<HjDerivativeStencilSingleLevelsetAdvector> {

 ...
 */
void HjReconstructionStencilSingleLevelsetAdvector::AdvectImplementation( Node& node ) const {
         ...
         for( unsigned int i = CC::FICX(); i <= CC::LICX(); ++i ) {
            ...
            if( std::abs( interface_tags[i][j][k] ) <= ITTI( IT::ExtensionBand ) ) {
               ...
               if constexpr( CC::DIM() != Dimension::One ) {
                  derivatives[1][0] = SU::Derivative<ReconstructionStencil, SP::UpwindLeft, Direction::Y>( levelset_reinitialized, i, j, k, 1.0 );
                  derivatives[1][1] = SU::Derivative<ReconstructionStencil, SP::UpwindRight, Direction::Y>( levelset_reinitialized, i, j, k, 1.0 );
               }

               if constexpr( CC::DIM() == Dimension::Three ) {
                  derivatives[2][0] = SU::Derivative<ReconstructionStencil, SP::UpwindLeft, Direction::Z>( levelset_reinitialized, i, j, k, 1.0 );
                  derivatives[2][1] = SU::Derivative<ReconstructionStencil, SP::UpwindRight, Direction::Z>( levelset_reinitialized, i, j, k, 1.0 );
               }

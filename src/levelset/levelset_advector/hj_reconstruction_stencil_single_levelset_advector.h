...
/**
 * @brief The HjHjReconstructionStencilSingleLevelsetAdvector propagates a single-level set field in time.
 */
class HjReconstructionStencilSingleLevelsetAdvector : public LevelsetAdvector<HjReconstructionStencilSingleLevelsetAdvector> {

   friend LevelsetAdvector;

   void AdvectImplementation(Node& node, const unsigned int stage = 0) const;

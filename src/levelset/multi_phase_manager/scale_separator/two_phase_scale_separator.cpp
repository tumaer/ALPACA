 ...
 */
TwoPhaseScaleSeparator::TwoPhaseScaleSeparator( MaterialManager const& material_manager, HaloManager& halo_manager ) : ScaleSeparator( material_manager, halo_manager ) {

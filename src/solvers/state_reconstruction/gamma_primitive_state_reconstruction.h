//===-------------- gamma_primitive_state_reconstruction.h ----------------===//
//
//                                 ALPACA
//
 ...
 * states for reconstruction ( except for gamma and pi where always the
 * conservative quantity is used ).
 */
class GammaPrimitiveStateReconstruction
    : public StateReconstruction<GammaPrimitiveStateReconstruction> {
...
public:
  ...
  GammaPrimitiveStateReconstruction(GammaPrimitiveStateReconstruction const &) =
      delete;
  GammaPrimitiveStateReconstruction &
  operator=(GammaPrimitiveStateReconstruction const &) = delete;
  GammaPrimitiveStateReconstruction(GammaPrimitiveStateReconstruction &&) =
      delete;
  GammaPrimitiveStateReconstruction &
  operator=(GammaPrimitiveStateReconstruction &&) = delete;
};

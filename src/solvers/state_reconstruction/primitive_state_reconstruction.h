...
/**
 * @brief Discretization of the spatial reconstruction scheme using primitive states for reconstruction.
 */
class PrimitiveStateReconstruction : public StateReconstruction<PrimitiveStateReconstruction> {
...
public:
   ...
   PrimitiveStateReconstruction& operator=( PrimitiveStateReconstruction const& ) = delete;
   PrimitiveStateReconstruction( PrimitiveStateReconstruction&& )                 = delete;
   PrimitiveStateReconstruction& operator=( PrimitiveStateReconstruction&& ) = delete;
};

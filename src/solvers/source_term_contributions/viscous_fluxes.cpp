 ...
 */
ViscousFluxes::ViscousFluxes( MaterialManager const& material_manager ) : material_manager_( material_manager ) {
 ...
 */
void ViscousFluxes::ComputeFluxes( std::pair<MaterialName const, Block> const& mat_block, double ( &dissipative_flux_x )[MF::ANOE()][CC::ICX() + 1][CC::ICY() + 1][CC::ICZ() + 1], double ( &dissipative_flux_y )[MF::ANOE()][CC::ICX() + 1][CC::ICY() + 1][CC::ICZ() + 1], double ( &dissipative_flux_z )[MF::ANOE()][CC::ICX() + 1][CC::ICY() + 1][CC::ICZ() + 1], double cell_size ) const {
 ...
 */
void ViscousFluxes::ComputeTauFluxes( double const ( &velocity_gradient_at_cell_faces )[CC::ICX() + 1][CC::ICY() + 1][CC::ICZ() + 1][DTI( CC::DIM() )][DTI( CC::DIM() )][DTI( CC::DIM() )], std::vector<double> const viscosity, double ( &tau )[CC::ICX() + 1][CC::ICY() + 1][CC::ICZ() + 1][DTI( CC::DIM() )][DTI( CC::DIM() )] ) const {

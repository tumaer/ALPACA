 ...
 * according to \cite Toro2009, chapter 10.4.
 */
class HllcRiemannSolver : public RiemannSolver<HllcRiemannSolver> {
  ...
  std::array<double, MF::ANOE()> SolveRiemannProblemImplementation(
    ...
    for (unsigned int n = 0; n < MF::ANOE(); ++n) {
      ...
      // Attention plus used for fluxes as other terms will also increment
      // elements.

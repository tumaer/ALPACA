 ...
 * according to \cite Fleischmann2020b.
 */
class HllcLMRiemannSolver : public RiemannSolver<HllcLMRiemannSolver> {
  ...
  std::array<double, MF::ANOE()> SolveRiemannProblemImplementation(
    ...
    auto const [wave_speed_left, wave_speed_right] = CalculateSignalSpeed(
        conservatives_left[ETI(Equation::Mass)],
        conservatives_right[ETI(Equation::Mass)], velocity_left, velocity_right,
        pressure_left, pressure_right, speed_of_sound_left,
    ...
    double const wave_speed_contact =
        ...
        (conservatives_left[ETI(Equation::Mass)] *
         ...
         conservatives_right[ETI(Equation::Mass)] *
             (wave_speed_right - velocity_right));
    double const chi_star_left = (wave_speed_left - velocity_left) /
                                 (wave_speed_left - wave_speed_contact);
    double const chi_star_right = (wave_speed_right - velocity_right) /
                                  (wave_speed_right - wave_speed_contact);

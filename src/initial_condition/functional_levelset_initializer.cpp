...
/**
 * @brief Constructs a functional levelset initializer with levelset initialization parameters given as input.
 ...
 */
FunctionalLevelsetInitializer::FunctionalLevelsetInitializer( std::string const& levelset_expression_string,
                                                              ...
                                                              unsigned int const maximum_level ) : LevelsetInitializer( bounding_boxes, material_names, node_size_on_level_zero, maximum_level ),
                                                                                                   ...
                                                                                                   levelset_expression_( UserExpression( levelset_expression_string_, { levelset_variable_name_ }, spatial_variable_names_, expression_point_ ) ) {
 ...
 */
double FunctionalLevelsetInitializer::ComputeSignedLevelsetValue( std::array<double, 3> const& point ) {
   std::copy( std::cbegin( point ), std::cend( point ), std::begin( expression_point_ ) );
 ...
 */
std::string FunctionalLevelsetInitializer::GetTypeLogData( unsigned int const indent ) const {
   // string that is returned
   std::string log_string;
   // Name of the levelset initializer
   log_string += StringOperations::Indent( indent ) + "Type     : Functional\n";
   // Function
   log_string += StringOperations::Indent( indent ) + "Function : " + levelset_expression_string_ + "\n";

//===--------- two_rarefaction_iterative_interface_riemann_solver.cpp -----===//
//
//                                 ALPACA
//
 ...
 */
std::array<double, 2> TwoRarefactionIterativeInterfaceRiemannSolver::
    ObtainFunctionAndDerivativeImplementation(
        double const initial_root, double const, double const,
        double const one_pressure_function, double const pressure_constant,
        double const, double const, double const C, double const D) const {

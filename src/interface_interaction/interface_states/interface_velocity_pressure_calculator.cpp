 ...
 *
 * @param[in]  material_manager  The material manager containing information about the materials involved in the simulation.
 */
InterfaceVelocityPressureCalculator::InterfaceVelocityPressureCalculator( MaterialManager const& material_manager ) : interface_riemann_solver_( material_manager ) {

 ...
 */
TopologyManager::TopologyManager( std::array<unsigned int, 3> const level_zero_blocks, unsigned int const maximum_level, unsigned int const active_periodic_locations ) :

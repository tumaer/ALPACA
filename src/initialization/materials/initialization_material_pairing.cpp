   ...
   MaterialPairing InitializeMaterialPairing( std::vector<unsigned int> const& material_indices,
      ...
      if constexpr( CC::CapillaryForcesActive() ) {
         if( surface_tension_coefficient_model_name != MaterialPropertyModelName::NotUsed ) {
            ...
            surface_tension_coefficient_model = InitializeSurfaceTensionCoefficientModel( surface_tension_coefficient_model_name, surface_tension_coefficient_model_data, unit_handler );
         } else {

...
class WENOAO53 : public Stencil<WENOAO53> {
   ...
   /**
    * @brief Evaluates the stencil according to WENO-AO(5,3) adaptive-order scheme from Balsara (2016). Also See base class.
   ...
   constexpr double ApplyImplementation( std::array<double, stencil_size_> const& array, std::array<int const, 2> const evaluation_properties, double const ) const {
      ...
      // Compute Legendre coefficients u according to Eq. (2.3-2.5), Eq. (2.16) amd smoothness indicators beta according to Eq. (2.6) and Eq. (2.19)
      ...
      double const beta_r5_3 = coef_smoothness_1_ * ( u_r5_31 + coef_smoothness_weight_5_1_ * u_r5_33 ) * ( u_r5_31 + coef_smoothness_weight_5_1_ * u_r5_33 ) + coef_smoothness_2_ * ( u_r5_32 + coef_smoothness_weight_5_2_ * u_r5_34 ) * ( u_r5_32 + coef_smoothness_weight_5_2_ * u_r5_34 ) + coef_smoothness_3_ * u_r5_33 * u_r5_33 + coef_smoothness_4_ * u_r5_34 * u_r5_34;

      // Compute normalized weights
      // Eq. (3.6)
      double const tau = ( Abs( beta_r5_3 - beta_r3_1 ) + Abs( beta_r5_3 - beta_r3_2 ) + Abs( beta_r5_3 - beta_r3_3 ) ) * one_third_;
      ...
      // Return value of reconstructed polynomial according to Eq. (3.11) Note: The polynomial constructed in the paper is always evaluated for x = 0.5 (cell face).

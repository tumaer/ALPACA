 ...
 * fluxes according to \cite Balsara2000.
 */
class WENO9 : public Stencil<WENO9> {
  ...
  /**
   * @brief Evaluates the stencil according to a WENO-9 scheme. Also See base
   * class.
  ...
  ApplyImplementation(std::array<double, stencil_size_> const &array,
    ...
    double const s11 = coef_smoothness_0_01_ * v1 + coef_smoothness_0_02_ * v2 +
                       coef_smoothness_0_03_ * v3 + coef_smoothness_0_04_ * v4 +
                       coef_smoothness_0_05_ * v5;
    double const s12 = coef_smoothness_0_06_ * v2 + coef_smoothness_0_07_ * v3 +
                       coef_smoothness_0_08_ * v4 + coef_smoothness_0_09_ * v5;
    double const s13 = coef_smoothness_0_10_ * v3 + coef_smoothness_0_11_ * v4 +
                       coef_smoothness_0_12_ * v5;
    ...
    double const s21 = coef_smoothness_1_01_ * v2 + coef_smoothness_1_02_ * v3 +
                       coef_smoothness_1_03_ * v4 + coef_smoothness_1_04_ * v5 +
                       coef_smoothness_1_05_ * v6;
    double const s22 = coef_smoothness_1_06_ * v3 + coef_smoothness_1_07_ * v4 +
                       coef_smoothness_1_08_ * v5 + coef_smoothness_1_09_ * v6;
    double const s23 = coef_smoothness_1_10_ * v4 + coef_smoothness_1_11_ * v5 +
                       coef_smoothness_1_12_ * v6;
    ...
    double const s31 = coef_smoothness_2_01_ * v3 + coef_smoothness_2_02_ * v4 +
                       coef_smoothness_2_03_ * v5 + coef_smoothness_2_04_ * v6 +
                       coef_smoothness_2_05_ * v7;
    double const s32 = coef_smoothness_2_06_ * v4 + coef_smoothness_2_07_ * v5 +
                       coef_smoothness_2_08_ * v6 + coef_smoothness_2_09_ * v7;
    double const s33 = coef_smoothness_2_10_ * v5 + coef_smoothness_2_11_ * v6 +
                       coef_smoothness_2_12_ * v7;
    ...
    double const s41 = coef_smoothness_3_01_ * v4 + coef_smoothness_3_02_ * v5 +
                       coef_smoothness_3_03_ * v6 + coef_smoothness_3_04_ * v7 +
                       coef_smoothness_3_05_ * v8;
    double const s42 = coef_smoothness_3_06_ * v5 + coef_smoothness_3_07_ * v6 +
                       coef_smoothness_3_08_ * v7 + coef_smoothness_3_09_ * v8;
    double const s43 = coef_smoothness_3_10_ * v6 + coef_smoothness_3_11_ * v7 +
                       coef_smoothness_3_12_ * v8;
    ...
    double const s51 = coef_smoothness_4_01_ * v5 + coef_smoothness_4_02_ * v6 +
                       coef_smoothness_4_03_ * v7 + coef_smoothness_4_04_ * v8 +
                       coef_smoothness_4_05_ * v9;
    double const s52 = coef_smoothness_4_06_ * v6 + coef_smoothness_4_07_ * v7 +
                       coef_smoothness_4_08_ * v8 + coef_smoothness_4_09_ * v9;
    double const s53 = coef_smoothness_4_10_ * v7 + coef_smoothness_4_11_ * v8 +
                       coef_smoothness_4_12_ * v9;
    ...
    //       s5 are of similar magnitude. Then, it cannot guaranteed anymore
    //       that a division by zero is avoided.
    double const a1 =
        coef_weights_1_ / ((s1 + epsilon_weno9_) * (s1 + epsilon_weno9_));
    double const a2 =
        coef_weights_2_ / ((s2 + epsilon_weno9_) * (s2 + epsilon_weno9_));
    double const a3 =
        coef_weights_3_ / ((s3 + epsilon_weno9_) * (s3 + epsilon_weno9_));
    double const a4 =
        coef_weights_4_ / ((s4 + epsilon_weno9_) * (s4 + epsilon_weno9_));
    double const a5 =
        coef_weights_5_ / ((s5 + epsilon_weno9_) * (s5 + epsilon_weno9_));
    ...
    return w1 * (coef_stencils_1_ * v1 + coef_stencils_2_ * v2 +
                 coef_stencils_3_ * v3 + coef_stencils_4_ * v4 +
                 coef_stencils_5_ * v5) +
           w2 * (coef_stencils_6_ * v2 + coef_stencils_7_ * v3 +
                 coef_stencils_8_ * v4 + coef_stencils_9_ * v5 +
                 coef_stencils_10_ * v6) +
           w3 * (coef_stencils_11_ * v3 + coef_stencils_12_ * v4 +
                 coef_stencils_13_ * v5 + coef_stencils_14_ * v6 +
                 coef_stencils_15_ * v7) +
           w4 * (coef_stencils_16_ * v4 + coef_stencils_17_ * v5 +
                 coef_stencils_18_ * v6 + coef_stencils_19_ * v7 +
                 coef_stencils_20_ * v8) +
           w5 * (coef_stencils_21_ * v5 + coef_stencils_22_ * v6 +
                 coef_stencils_23_ * v7 + coef_stencils_24_ * v8 +
                 coef_stencils_25_ * v9);
  }

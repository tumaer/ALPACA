 ...
 */
double TENO5::ApplyImplementation( std::array<double, stencil_size_> const& array, std::array<int const, 2> const evaluation_properties, double const ) const {
   ...
   double one_a_sum = 1.0 / (a1 + a2 + a3);

   double b1 = a1 * one_a_sum;
   double b2 = a2 * one_a_sum;
   double b3 = a3 * one_a_sum;

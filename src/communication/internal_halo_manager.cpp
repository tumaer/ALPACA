 ...
 */
InternalHaloManager::InternalHaloManager( Tree& tree, TopologyManager& topology, CommunicationManager& communication_manager, unsigned int const number_of_materials ) : tree_( tree ),
                                                                                                                                                                         topology_( topology ),

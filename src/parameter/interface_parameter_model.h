...
/**
 * @brief The InterfacePropertyModel class defines an interface for different discretizations of a model to compute material and material pairing parameters

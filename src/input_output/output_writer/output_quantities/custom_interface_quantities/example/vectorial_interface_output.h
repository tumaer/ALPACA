...
*                                                                                        *
*****************************************************************************************/
#ifndef VECTORIAL_INTERFACE_OUTPUT_H
#define VECTORIAL_INTERFACE_OUTPUT_H

#include "input_output/output_writer/output_quantity.h"
#include "topology/node.h"

/**
 * @brief Example class for a vectorial interface quantity that writes interface data to the output. Interface data is defined as
 *        all data operating on a interface block. The difference to material outputs is that those operate on Material blocks.
 *
 * To define a new vectorial interface quantity this file can be used to define the appropriate functions. Simply take the current loop structure and
 ...
 */
class VectorialInterfaceOutput : public OutputQuantity {
...
public:
   ...
   explicit VectorialInterfaceOutput( UnitHandler const& unit_handler,

 ...
 */
NumericalSchlierenOutput::NumericalSchlierenOutput( UnitHandler const& unit_handler,
 ...
 */
void NumericalSchlierenOutput::DoComputeCellData( Node const& node, std::vector<double>& cell_data, unsigned long long int& cell_data_counter ) const {
   ...
   double const dimensionalization_factor = unit_handler_.DimensionalizeValue( 1.0, { UnitType::Density }, { UnitType::Length } );
 ...
 */
void NumericalSchlierenOutput::DoComputeDebugCellData( Node const& node, std::vector<double>& cell_data, unsigned long long int& cell_data_counter, MaterialName const material ) const {

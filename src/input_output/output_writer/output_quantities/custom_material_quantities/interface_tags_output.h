...
//
//===----------------------------------------------------------------------===//
#ifndef INTERFACE_TAGS_OUTPUT_H
#define INTERFACE_TAGS_OUTPUT_H

#include "input_output/output_writer/output_quantity.h"
#include "topology/node.h"

/**
 * @brief The InterfaceTagsOutput class handles the output of the rank number
 * into a output file (currently Xdmf + HDF5). InterfaceTagsOutput must not
 * change any data.
 */
class InterfaceTagsOutput : public OutputQuantity {
...
public:
  ...
  explicit InterfaceTagsOutput(UnitHandler const &unit_handler,

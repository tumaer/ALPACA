...
/**
 * @brief The InterfaceTagsOutput class handles the output of the rank number into a output file (currently Xdmf + HDF5).
 *        InterfaceTagsOutput must not change any data.
 */

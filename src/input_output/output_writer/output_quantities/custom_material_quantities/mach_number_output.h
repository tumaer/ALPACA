...
/**
 * @brief The MachNumberOutput class handles the output of the Mach number into a output file (currently Xdmf + HDF5).
 *        MachNumberOutput must not change any data.
 */

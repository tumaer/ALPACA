...
/**
 * @brief The VortexDilatationOutput class handles the output of the vortex dilatation term of the vorticity transport equation
 *        into a output file (currently Xdmf + HDF5). VortexDilatationOutput must not change any data.
 */

...
/**
 * @brief Example class for a vectorial output quantity that writes material data to the output. Material data is defined as
 *        all data operating on a material block. The difference to interface outputs is that those operate on interface
 ...
 *
 * To define a new vectorial material quantity this file can be used to define the appropriate functions. Simply take the current loop structure and

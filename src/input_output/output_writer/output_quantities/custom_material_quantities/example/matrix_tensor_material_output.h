...
*                                                                                        *
*****************************************************************************************/
#ifndef MATRIX_TENSOR_MATERIAL_OUTPUT_H
#define MATRIX_TENSOR_MATERIAL_OUTPUT_H

#include "input_output/output_writer/output_quantity.h"
#include "topology/node.h"

/**
 * @brief Example class for a matrix/tensor output quantity that writes material data to the output. Material data is defined as
 *        all data operating on material blocks. The difference to interface outputs is that those mainly operate on interface
 *        blocks. Furthermore, a special distinction is made in the debug output mode, where for material quantities for
 *        each material all nodes are written. If the node does not contain the material a default value is written.
 *
 * To define a new matrix material quantity this file can be used to define the appropriate functions. Simply take the current loop structure and
 ...
 * An output quantity is defiend as a matrix if any component exceeds the current dimension of the simulation or the matrix is not of type n x n. Otherwise it is a tnsor.
 */
class MatrixTensorMaterialOutput : public OutputQuantity {

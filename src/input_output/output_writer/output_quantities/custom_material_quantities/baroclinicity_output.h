...
//
//===----------------------------------------------------------------------===//
#ifndef BAROCLINICITY_OUTPUT_H
#define BAROCLINICITY_OUTPUT_H

#include "input_output/output_writer/output_quantity.h"
#include "topology/node.h"

/**
 * @brief The BaroclinicityOutput class handles the output of the baroclinicity
 * term of the vorticity transport equation into a output file (currently Xdmf +
 * HDF5). BaroclinicityOutput must not change any data.
 */

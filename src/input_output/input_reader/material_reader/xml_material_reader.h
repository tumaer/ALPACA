...
class XmlMaterialReader : public MaterialReader {
   ...
   std::string DoReadModelName( std::vector<unsigned int> const& material_indices, MaterialProperty const property ) const override;
   std::unordered_map<std::string, double> DoReadModelData( std::vector<unsigned int> const& material_indices, MaterialProperty const property ) const override;

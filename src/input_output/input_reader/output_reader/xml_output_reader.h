...
/**
 * @brief Class that implements the actual reading procedure of output data from input files of xml-type.
...
class XmlOutputReader : public OutputReader {
   ...
   std::string DoReadOutputTimesType( OutputType const output_type ) const override;
   double DoReadOutputInterval( OutputType const output_type ) const override;
   std::vector<double> DoReadOutputTimeStamps( OutputType const output_type ) const override;

 ...
 */
StiffenedGasCompleteSafe::StiffenedGasCompleteSafe( std::unordered_map<std::string, double> const& dimensional_eos_data, UnitHandler const& unit_handler ) : gamma_( GetCheckedParameter<double>( dimensional_eos_data, "gamma", "StiffenedGasCompleteSafe" ) ),
                                                                                                                                                             energy_translation_factor_( unit_handler.NonDimensionalizeValue( GetCheckedParameter<double>( dimensional_eos_data, "energyTranslationFactor", "StiffenedGasCompleteSafe" ),
                                                                                                                                                                                                                              { UnitType::Velocity, UnitType::Velocity }, {} ) ),
                                                                                                                                                             background_pressure_( unit_handler.NonDimensionalizeValue( GetCheckedParameter<double>( dimensional_eos_data, "backgroundPressure", "StiffenedGasCompleteSafe" ), UnitType::Pressure ) ),
                                                                                                                                                             thermal_energy_factor_( unit_handler.NonDimensionalizeValue( GetCheckedParameter<double>( dimensional_eos_data, "thermalEnergyFactor", "StiffenedGasCompleteSafe" ),
                                                                                                                                                                                                                          { UnitType::Velocity, UnitType::Velocity }, { UnitType::Temperature } ) ),
                                                                                                                                                             specific_gas_constant_( unit_handler.NonDimensionalizeValue( GetCheckedParameter<double>( dimensional_eos_data, "specificGasConstant", "StiffenedGasCompleteSafe" ),
                                                                                                                                                                                                                          { UnitType::Velocity, UnitType::Velocity }, { UnitType::Temperature } ) ) {
...
/**
 * @brief Computes Energy according to stiffened gas complete equation, but secured against division by zero.

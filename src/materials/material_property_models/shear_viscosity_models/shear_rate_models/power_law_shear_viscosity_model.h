...
/**
 * @brief Class that provides the actual model implementation param = f(gamma_dot) following a power law. for a shear-rate based material parameter model to compute
 *        the shear viscosity in the field. The model is implemented based on \cite{Deville2012}.
 */
class PowerLawShearViscosityModel : public ShearRateMaterialParameterModel<PowerLawShearViscosityModel> {

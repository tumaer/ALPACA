...
/**
 * @brief Class that provides the actual model implementation param = f(gamma_dot) following the Carreau-Yasuda model. for a shear-rate based material parameter model to compute
 *        the shear viscosity in the field. The model is implemented based on \cite{Bird1987}.
 */
class CarreauYasudaShearViscosityModel : public ShearRateMaterialParameterModel<CarreauYasudaShearViscosityModel> {

 ...
 *        the field (dependent) thermal conductivity. This model only serves as a complement to the other material parameter models to provide
 *        field dependent computations for all materials if at least one uses a real parameter model.
 */
class ConstantThermalConductivityModel : public ConstantMaterialParameterModel<ConstantThermalConductivityModel> {

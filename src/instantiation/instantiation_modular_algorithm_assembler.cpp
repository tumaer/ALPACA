...
namespace Instantiation {
   ...
   /**
    * @brief Instantiates the complete modular algorithm assembler class with the given input classes.
    ...
    */
   ModularAlgorithmAssembler InstantiateModularAlgorithmAssembler( InputReader const& input_reader,

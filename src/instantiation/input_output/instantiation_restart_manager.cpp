...
namespace Instantiation {
   ...
   /**
    * @brief Instantiates the complete restart manager class with the given input classes.
    ...
    * @return The fully instantiated RestartManager class as pointer (allows movements of it).
    */

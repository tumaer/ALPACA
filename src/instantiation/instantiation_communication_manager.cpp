...
namespace Instantiation {
   ...
   /**
    * @brief Instantiates the complete communication manager class with the given input classes.
    ...
    */
   CommunicationManager InstantiateCommunicationManager( TopologyManager& topology_manager ) {

...
namespace Instantiation {
   ...
   /**
   * @brief Instantiates the material boundary conditions with the given input data. Periodic Boundary conditions are not created.
   ...
   */
   ...
   /**
   * @brief Instantiates the levelset boundary conditions with the given input data. Periodic Boundary conditions are not created.
   * @param bc_reader Reader to provide access to the boundary conditions in the input data.
   ...
   */
   ...
   /**
    * @brief Instantiates the complete external halo manager class with the given input reader and other classes.
   ...
   ExternalHaloManager InstantiateExternalHaloManager( InputReader const& input_reader,
      ...
      std::array<std::unique_ptr<MaterialBoundaryCondition const>, 6> material_boundaries(
            InstantiateMaterialBoundaryConditions( input_reader.GetBoundaryConditionReader(), unit_handler, material_manager ) );

      std::array<std::unique_ptr<LevelsetBoundaryCondition const>, 6> levelset_boundaries(
            InstantiateLevelsetBoundaryConditions( input_reader.GetBoundaryConditionReader() ) );

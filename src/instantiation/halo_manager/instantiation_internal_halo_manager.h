...
/**
 * @brief Defines all instantiation functions required for the internal halo manager.
 */
namespace Instantiation {

   // Instantiation function of the internal halo manager
   InternalHaloManager InstantiateInternalHaloManager( TopologyManager& topology_manager,
                                                       Tree& tree,

...
/***********************************/
SCENARIO( "Standard mesh generator with mpi-filtering: Dimension of global vertex coordinates vector is correctly computed", "[1rank],[2rank]" ) {
   ...
   GIVEN( "Underlying topology with Lmax being one" ) {
      ...
      std::unique_ptr<MeshGenerator const> mesh_generator = std::make_unique<StandardMpiMeshGenerator const>( topology, tree, 1.0, true );
...
/***********************************/
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex Coordinates local dimensions to write are correctly determined", "[1rank]" ) {
...
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex Coordinates local dimensions to write are correctly determined on 2 tanks", "[2rank]" ) {
...
/* 3. Start index check            */
/***********************************/
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex Coordinates start index to write is correctly determined", "[1rank]" ) {
...
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex Coordinates start index to write is correctly determined on two ranks", "[2rank]" ) {
...
/* 4. Computation check            */
/***********************************/
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex coordinates node corner points are correctly written out", "[1rank]" ) {
...
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex coordinates node corner points are correctly written out on two ranks", "[2rank]" ) {
...
/***********************************/
SCENARIO( "Standard mesh generator with mpi-filtering: Dimension of global vertex IDs vector is correctly computed", "[1rank],[2rank]" ) {
...
/***********************************/
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex IDs local dimensions to write are correctly determined", "[1rank]" ) {
...
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex IDs local dimensions to write are correctly determined on two ranks", "[2rank]" ) {
...
/* 3. Start index check            */
/***********************************/
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex IDs start index to write is correctly determined", "[1rank]" ) {
...
SCENARIO( "Standard mesh generator with mpi-filtering: Vertex IDs start index to write is correctly determined on two ranks", "[2rank]" ) {
...
/********************************************************************************************************************************************/ 
SCENARIO( "Standard mesh generator with mpi-filtering: Check that vertex IDs and coordinates are computed properly in combination", "[1rank]" ) {
...
SCENARIO( "Standard mesh generator with mpi-filtering: Check that vertex IDs and coordinates are computed properly in combination on two ranks", "[2rank]" ) {

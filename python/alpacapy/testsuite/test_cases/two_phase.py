...
class TwoPhase(Testcase):
    """ Two phase Testcase

    This class implements the TwoPhase test case for the ALPACA testsuite. The two phase test cases can be run in 1D, 2D and 3D.
    The inputfiles for the different test cases can be found under alpacapy/Testsuite/InputData/Inputfiles/TwoPhase. It provides the detailed
